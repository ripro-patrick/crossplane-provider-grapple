...
The [provider-grpl](https://github.com/ripro-patrick/crossplane-provider-grapple) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/ripro-patrick/crossplane-provider-grapple/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/ripro-patrick/crossplane-provider-grapple/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/ripro-patrick/crossplane-provider-grapple/blob/main/hack/boilerplate.go.txt](https://github.com/ripro-patrick/crossplane-provider-grapple/blob/main/hack/boilerplate.go.txt)
...
The [provider-grpl](https://github.com/ripro-patrick/crossplane-provider-grapple)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/ripro-patrick/crossplane-provider-grapple/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/ripro-patrick/crossplane-provider-grapple/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue grpls (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/ripro-patrick/crossplane-provider-grapple/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request grpls: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/ripro-patrick/crossplane-provider-grapple/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
